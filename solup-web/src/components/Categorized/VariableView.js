...
function VariableView() {
  ...
  const updateTradeHistories = async () => {
    try {
      const response = await fetch(`/account/${userId}/categorized-variable`);
      const jsonResponse = await response.json();
      const data = jsonResponse.data.tradeHistories;
      const withdraw = jsonResponse.data.totalWithdraw;
      setTotalWithdraw(withdraw);
      console.log(jsonResponse.data.totalWithdraw);
